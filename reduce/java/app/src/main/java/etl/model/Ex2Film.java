...
public interface Ex2Film
{
    ...
    interface Extracting
    {
         ...
         */
        static Ex2Film.Model model(final Ex2Film.Text text)
        {
         ...
         */
        static Ex2Film.Text text(final CSVRecord csv)
        {
         ...
         */
        static final Constructor<Ex2Film.Text> text_ctor
        = TextHelper.ctor(Ex2Film.Text.class);
        ...
        static Stream<Model> models(
            ...
            final var models = ModelReader.stream(
                supplier,
                Ex2Film.Text.class,
                Ex2Film.Extracting::text,
                Ex2Film.Extracting::model
            );
            return models;
        }
    }
